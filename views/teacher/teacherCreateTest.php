	...
	if ($_SESSION['credentials']->is_teacher()) {
		...
		<section id="main" class="wrapper style1">
			...
			<div class="testContainer">
				...
				<div id="slidingDiv_0" class="toggleDiv" style="display:inline-block; min-width: 40%; float: left;"> 
				...
				<div id="slidingDiv_1" class="toggleDiv" style="display:none; min-width: 40%; float: left;"> 
				...
				<div id="slidingDiv_2" class="toggleDiv" style="display:none; min-width: 40%; float: left;"> 
					<section id="TorF">
				...
				<div id="slidingDiv_3" class="toggleDiv" style="display:none; min-width: 40%; float: left;"> 
					<section id="essayQuestion">
						<div id="my-form-builder" align="left">
				...
				<div style="float:right; inline-block; min-width: 60%;"> 
					<section id="testView">
						<div id="my-form-builder" align="left" style="padding-left: 200px;">
							<h4>Test</h4>
							<br />
						</div>
					</section>
