<?php
	if(isset($_REQUEST['question_id'], $_REQUEST['question_text'], $_REQUEST['question_weight'])) {
		...
		$editStatement->bind_param("isi", $question_id, $question_text, $question_weight) or die($editStatement->error);
