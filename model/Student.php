<?php
	...
	class Student {
		...
		// Print classes with the grade average for this student in an HTML table format
		public function print_classes_with_grades($student_id) {
			$db = $this->prepare_connection();
			$statement = $db->prepare("SELECT class_number, class_name, class_id, 
			...
			$statement->bind_result($class_number, $class_name, $class_id, $average);
			...
			if($statement->num_rows > 0){
				...
				echo "<tr> <td colspan='3'> No Classes </td> </tr>";
			}
		}
		...
		public function print_classes($student_id) {
			...
			$statement->execute();
			$statement->store_result();
			$statement->bind_result($class_number, $class_name, $class_id);
